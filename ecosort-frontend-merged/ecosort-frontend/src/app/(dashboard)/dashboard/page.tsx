  ...
  return (
    <div>
      <div className="relative h-40 w-full overflow-hidden rounded-xl sm:h-52">
        <Image
          src="/images/illustrations/dashboard-banner.svg"
          alt=""
          fill
          priority
          className="object-cover"
        />
        <div className="absolute inset-0 flex flex-col justify-center bg-gradient-to-r from-accent-700/80 via-accent-700/40 to-transparent px-6 sm:px-8">
          <h1 className="text-xl font-semibold text-white sm:text-2xl">
            Welcome back{user ? `, ${user.fullName.split(" ")[0]}` : ""}
          </h1>
          <p className="mt-1 max-w-md text-sm text-accent-50/90">
